...
function timeElapse(c) {
	...
	var a = '<span style="margin-left:50px;" class="digit">' + g + '</span> días <span class="digit">' + b + '</span> horas <span class="digit">' + d + '</span> minutos <span class="digit">' + f + "</span> segundos";
	$("#elapseClock").html(a)
}
